...
export const translations: Record<Language, Record<string, TranslationValues>> = {
  en: {
    ...
    settings: {
      title: "Settings",
      description: "Adjust how Bytebot works for your team.",
      languageSection: {
        title: "Language",
      ...
      customModels: {
        title: "Custom models",
        description:
          "Add custom API models so they appear in the task creation model list.",
        empty: "No custom models yet. Add your first model to get started.",
        deleteConfirmation:
          "Remove {{title}}? This model will disappear from the model picker.",
        contextWindowUnit: "{{value}} tokens",
        form: {
          providerLabel: "Provider",
          providerPlaceholder: "e.g. openai, anthropic, custom",
          nameLabel: "Model name",
          namePlaceholder: "my-awesome-model",
          titleLabel: "Display name",
          titlePlaceholder: "My awesome model",
          contextWindowLabel: "Context window (tokens)",
          contextWindowPlaceholder: "Optional",
          saveButton: "Add model",
          updateButton: "Update model",
          validation: {
            required: "Model name and display name are required.",
            contextWindow: "Context window must be a positive number.",
            generic: "We couldn't save the model. Please try again.",
          },
        },
      },
    },
  ...
  "zh-CN": {
    ...
    settings: {
      title: "设置",
      description: "调整 Bytebot 的工作方式以符合你的需求。",
      languageSection: {
        title: "界面语言",
      ...
      customModels: {
        title: "自定义模型",
        description: "添加自定义 API 模型，让它们出现在新建任务的模型列表中。",
        empty: "还没有自定义模型，添加一个模型开始使用。",
        deleteConfirmation: "要移除 {{title}} 吗？该模型将不再出现在模型列表中。",
        contextWindowUnit: "上下文 {{value}} 个 Token",
        form: {
          providerLabel: "提供商",
          ...
          namePlaceholder: "my-awesome-model",
          titleLabel: "显示名称",
          titlePlaceholder: "我的自定义模型",
          contextWindowLabel: "上下文窗口（Token）",
          contextWindowPlaceholder: "可选",
          saveButton: "添加模型",
          updateButton: "更新模型",
          validation: {
            required: "请填写模型名称和显示名称。",
            contextWindow: "上下文窗口必须为正整数。",
            generic: "保存模型失败，请重试。",
          },
        },
      },
  ...
  "zh-TW": {
    ...
    settings: {
      title: "設定",
      description: "調整 Bytebot 的運作方式以符合你的需求。",
      languageSection: {
        title: "介面語言",
        description: "選擇介面顯示的語言。",
      },
      customModels: {
        title: "自訂模型",
        description: "新增自訂 API 模型，讓它們出現在建立任務的模型清單中。",
        empty: "尚未新增自訂模型，先建立一個開始使用。",
        deleteConfirmation: "要移除 {{title}} 嗎？該模型將從模型清單中消失。",
        contextWindowUnit: "上下文 {{value}} 個 Token",
        form: {
          providerLabel: "提供商",
          providerPlaceholder: "例如 openai、anthropic、custom",
          nameLabel: "模型名稱",
          namePlaceholder: "my-awesome-model",
          titleLabel: "顯示名稱",
          titlePlaceholder: "我的自訂模型",
          contextWindowLabel: "上下文視窗（Token）",
          contextWindowPlaceholder: "選填",
          saveButton: "新增模型",
          updateButton: "更新模型",
          validation: {
            required: "請填寫模型名稱與顯示名稱。",
            contextWindow: "上下文視窗必須為正整數。",
            generic: "儲存模型失敗，請再試一次。",
          },
        },
      },
    },
